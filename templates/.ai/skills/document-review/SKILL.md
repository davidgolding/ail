...
```
Skill("ail:document-review", "mode:headless docs/plans/my-plan.md")
```
...
**If no document is specified (headless mode):** Output "Review failed: headless mode requires a document path. Re-invoke with: Skill(\"ail:document-review\", \"mode:headless <path>\")" without dispatching agents.
...
Always include:
- `ail:document-review:coherence-reviewer`
- `ail:document-review:feasibility-reviewer`

Add activated conditional personas:
- `ail:document-review:product-lens-reviewer`
- `ail:document-review:design-lens-reviewer`
- `ail:document-review:security-lens-reviewer`
- `ail:document-review:scope-guardian-reviewer`
- `ail:document-review:adversarial-document-reviewer`
...
2. **Review complete** -- description based on document type:
   - requirements document: "Create technical plan with ail-plan"
   - plan document: "Implement with ail-work"
