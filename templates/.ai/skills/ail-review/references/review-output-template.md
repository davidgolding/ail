...
- [Known Pattern] `solutions/export-pagination.md` -- previous export pagination fix applies to this endpoint
...
- **Learnings & Past Solutions section** -- results from learnings-researcher, with links to solutions/ files
