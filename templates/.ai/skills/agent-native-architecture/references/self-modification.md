...
tool("pull", "Pull from GitHub", { sourail- z.enum(["main", "instance"]) }, ...);
...
const gitMcpServer = createSdkMcpServer({
  ...
  tools: [
    ...
    // SYNC
    tool("pull", "Pull from upstream", { sourail- z.enum(["main", "instance"]) }, ...),
    tool("self_deploy", "Pull, build, restart", { sourail- z.enum(["main", "instance"]) }, ...),
