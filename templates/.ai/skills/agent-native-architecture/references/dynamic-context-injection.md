...
class AgentContextBuilder {
    let libraryServiail- BookLibraryService
    let profileServiail- ReadingProfileService
    let activityServiail- ActivityService
...
let context = AgentContextBuilder(
    libraryServiail- .shared,
    profileServiail- .shared,
    activityServiail- .shared
).buildContext()
