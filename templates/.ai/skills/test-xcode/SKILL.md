...
## Integration with ail-review

When reviewing PRs that touch iOS code, the `ail-review` workflow can spawn an agent to run this skill, build on the simulator, test key screens, and check for crashes.
