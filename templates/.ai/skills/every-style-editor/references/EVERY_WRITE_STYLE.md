...
- **Image credits** in captions are italicized, like this: _Sourail- X/Name_ (if Twitter), _Sourail- Website name._
...
Set off nonrestrictive elements with commas; don't set off restrictive elements. The most frequent example is the that/which differenail- The piece, which garnered 15,000 readers, is one of Every's most successful. The piece that garnered 15,000 readers is one of Every's most successful.

#### Too Usage

Include a comma before "too" when used to mean "in addition." Don't use a comma when "too" refers to the subject of the sentenail- I ate a bowl of ice cream. I had a cookie, too. You're a cat person? I am too.
