...
1. **Repo conventions already in context** -- If project instructions (.ai/system.md, .ai/system.md, or similar) are already loaded and specify commit message conventions, follow those. Do not re-read these files; they are loaded at session start.
