...
To detect the correct port, check project instruction files (`.ai/system.md`, `.ai/system.md`) for port references, then `package.json` dev scripts, then `.env` files, falling back to `3000`.
