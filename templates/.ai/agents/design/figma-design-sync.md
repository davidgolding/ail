...
5. **Precise Implementation**: Make the necessary code changes to fix all identified differences:
   ...
   - Ensure changes follow the project's coding standards from .ai/system.md
...
- **Code Quality**: Follow .ai/system.md guidance for project-specific frontend conventions
