...
<example>
Context: User is running ail-ideate with a focus on bugs and issue patterns.
user: "/ail-ideate bugs"
...
<commentary>The ail-ideate skill detected issue-tracker intent and dispatches this agent as a third parallel Phase 1 scan alongside codebase context and learnings search.</commentary>
</example>
<example>
...
### Theme 1: {theme_title}
**Issues:** {count} | **Trend:** {direction} | **Confidenail-** {level}
...
- `ail-ideate` — as a third parallel Phase 1 scan when issue-tracker intent is detected
