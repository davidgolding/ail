...
1. **Discover Available Skills**:
   ...
   - If the current environment provides an `.ai/system.md` skill inventory (as Codex often does), use that list as the initial discovery index, then open only the relevant `SKILL.md` files
...
2. **Identify Relevant Skills**:
  ...
  - Documentation → `ail-compound`, `every-style-editor`
...
**Before recommending any external API, OAuth flow, SDK, or third-party serviail-**
...
2. **Organize Discoveries**:
   ...
   - Clearly indicate sourail- "From skill: dhh-rails-style" vs "From official docs" vs "Community consensus"
