...
1. **Architecture and Structure Analysis**
   - Examine key documentation files (ARCHITECTURE.md, README.md, CONTRIBUTING.md, .ai/system.md, and .ai/system.md only if present for compatibility)
...
- Respect any .ai/system.md or other project-specific instructions found
